// Cheng Yao @ 2013
// :-D -- Stolen from live555/testProgs/playCommon.cpp
...
void continueAfterOPTIONS(WFDSink* client, int resultCode, char* resultString);
void continueAfterDESCRIBE(WFDSink* client, int resultCode, char* resultString);
void continueAfterSETUP(WFDSink* client, int resultCode, char* resultString);
void continueAfterPLAY(WFDSink* client, int resultCode, char* resultString);
void continueAfterTEARDOWN(WFDSink* client, int resultCode, char* resultString);
...
int main(int argc, char** argv) {
  ...
  /*if (sendOptionsRequest) {
    ...
    //continueAfterDESCRIBE(NULL, 0, NULL);
  }*/
  //ourClient->start();
...
void continueAfterOPTIONS(WFDSink*, int resultCode, char* resultString) {
...
void waitForGETPARAMETER(WFDSink*, int resultCode, char* resultString) {
}

void continueAfterDESCRIBE(WFDSink*, int resultCode, char* resultString) {
  if (resultCode != 0) {
...
MediaSubsession *subsession;
Boolean madeProgress = False;
void continueAfterSETUP(WFDSink*, int resultCode, char* resultString) {
  if (resultCode == 0) {
...
void continueAfterPLAY(WFDSink*, int resultCode, char* resultString) {
  if (resultCode != 0) {
...
void continueAfterTEARDOWN(WFDSink*, int /*resultCode*/, char* /*resultString*/) {
